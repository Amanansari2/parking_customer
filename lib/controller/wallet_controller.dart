...
import 'package:parkinghawkernew/model/bank_details_model.dart';
import 'package:parkinghawkernew/model/payment/razorpay_failed_model.dart';
import 'package:parkinghawkernew/model/payment/xenditModel.dart';
import 'package:parkinghawkernew/model/payment_method_model.dart';
import 'package:parkinghawkernew/model/user_model.dart';
import 'package:parkinghawkernew/model/wallet_transaction_model.dart';
import 'package:parkinghawkernew/payment/MercadoPagoScreen.dart';
import 'package:parkinghawkernew/payment/PayFastScreen.dart';
import 'package:parkinghawkernew/payment/getPaytmTxtToken.dart';
import 'package:parkinghawkernew/payment/midtrans_screen.dart';
import 'package:parkinghawkernew/payment/orangePayScreen.dart';
import 'package:parkinghawkernew/payment/paystack/pay_stack_screen.dart';
import 'package:parkinghawkernew/payment/paystack/pay_stack_url_model.dart';
import 'package:parkinghawkernew/payment/paystack/paystack_url_genrater.dart';
import 'package:parkinghawkernew/payment/stripe_failed_model.dart';
import 'package:parkinghawkernew/payment/xenditScreen.dart';
...
//Orangepay payment
  ...
  Future fetchToken({required String orderId, required String currency, required BuildContext context, required String amount}) async {
    ...
    var response = await http.post(Uri.parse(apiUrl),
        headers: <String, String>{
          'Authorization': "Basic ${paymentModel.value.orangePay!.auth!.trim()}",
  ...
  Future webpayment({required String orderIdData, required BuildContext context, required String currency, required String amountData}) async {
    ...
    if (response.statusCode == 201) {
      ...
      ShowToastDialog.showToast("Something went wrong, please contact admin.", position: EasyLoadingToastPosition.bottom);
      // ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      //     backgroundColor: Color(0xff635bff),
      //     content: Text(
      //       "Something went wrong, please contact admin.",
