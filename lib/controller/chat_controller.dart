...
import 'package:parkinghawkernew/ui/chat/model/chat_model.dart';
...
class ChatController extends GetxController {
  ...
  sendMessage() async {
    var lastMessageToClear=messageTextEditorController.value.text.trim();
    messageTextEditorController.value.clear();
    InboxModel inboxModel = InboxModel(
        archive: false,
        lastMessage: lastMessageToClear,
        mediaUrl: "",
    ...
    await SendNotification.sendOneNotification(
        token: receiverUserModel.value.fcmToken.toString(), title: receiverUserModel.value.fullName.toString(), body: lastMessageToClear, payload: playLoad);
  }
