...
import 'package:parkinghawkernew/controller/review_summary_controller.dart';
...
import 'package:parkinghawkernew/ui/booking_process/payment_select_screen.dart';
import 'package:parkinghawkernew/ui/chat/chat_screen.dart';
import 'package:parkinghawkernew/ui/live_tracking_screen/live_tracking_screen.dart';
import 'package:parkinghawkernew/ui/review/review_screen.dart';
...
import 'package:parkinghawkernew/utils/utils.dart';
                    ...
                    child: Column(
                      children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: ShapeDecoration(
                                    color: controller.orderModel.value.paymentCompleted == true ? AppThemData.success02 : AppThemData.grey03,
                        ...
                        Visibility(
                          ...
                          child: Visibility(
                            visible:
                                controller.orderModel.value.paymentCompleted == false && controller.orderModel.value.paymentType.toString().toLowerCase() == 'cash'.toLowerCase()
                                    ? false
                                    : true,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
