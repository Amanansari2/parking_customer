...
import 'package:parkinghawkernew/controller/wallet_controller.dart';
import 'package:parkinghawkernew/model/wallet_transaction_model.dart';
import 'package:parkinghawkernew/model/withdraw_model.dart';
import 'package:parkinghawkernew/payment/createRazorPayOrderModel.dart';
import 'package:parkinghawkernew/payment/rozorpayConroller.dart';
...
import 'package:parkinghawkernew/themes/round_button_fill.dart';
import 'package:parkinghawkernew/themes/round_button_gradient_icon.dart';
import 'package:parkinghawkernew/themes/text_field_widget.dart';
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: const DecorationImage(image: ExactAssetImage('assets/logo/wallet_background.png'), fit: BoxFit.fill),
                          ...
                          child: Column(children: [
                            Padding(
                              ...
                              child: Text(
                                "Total Amount".tr,
                                style: TextStyle(fontSize: 24, fontFamily: AppThemData.medium, color: themeChange.getThem() ? AppThemData.white : AppThemData.labelColorLightPrimary),
                              ),
                            ),
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 32, fontFamily: AppThemData.bold, color: themeChange.getThem() ? AppThemData.white : AppThemData.labelColorLightPrimary),
                              ),
                            ),
                            const SizedBox(
                              height: 8,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: RoundedButtonFillGradientIcon(
                                      title: "Add Cash".tr,
                                      textColor: themeChange.getThem() ? AppThemData.white : AppThemData.labelColorLightPrimary,
                                      icon: Icon(Icons.add, color: themeChange.getThem() ? AppThemData.white : AppThemData.labelColorLightPrimary),
                                      isRight: false,
                                      onPress: () {
                            ...
                            child: Column(
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: cardDecoration(controller, controller.paymentModel.value.xendit!.name.toString(), themeChange, "assets/images/xendit.png"),
                                ),
                                Visibility(
                                  visible: controller.paymentModel.value.orangePay != null && controller.paymentModel.value.orangePay!.enable == true,
                                  child: cardDecoration(controller, controller.paymentModel.value.orangePay!.name.toString(), themeChange, "assets/images/orangeMoney.png"),
                                ),
                                Visibility(
                                  visible: controller.paymentModel.value.midtrans != null && controller.paymentModel.value.midtrans!.enable == true,
                                  child: cardDecoration(controller, controller.paymentModel.value.midtrans!.name.toString(), themeChange, "assets/images/midtrans.png"),
                                ),
                                const SizedBox(
                                  height: 10,
                                ),
                            ...
                            if (controller.amountController.value.text.isNotEmpty) {
                              ...
                              if (double.parse(controller.amountController.value.text) >= double.parse(Constant.minimumAmountToDeposit.toString())) {
                                ...
                                // }
                                  ...
                                  controller.orangeMakePayment(amount: controller.amountController.value.text.toString(), context: context);
