...
import 'package:parkinghawkernew/controller/inbox_controller.dart';
...
import 'package:parkinghawkernew/ui/chat/model/inbox_model.dart';
...
import 'package:parkinghawkernew/widgets/firebase_pagination/src/firestore_pagination.dart';
        ...
        return Scaffold(
          ...
          body: controller.isLoading.value
              ...
              : FirestorePagination(
                  ...
                  query:
                      FireStoreUtils.fireStore.collection(CollectionName.chat).doc(controller.senderUserModel.value.id).collection("inbox").orderBy("timestamp", descending: false),
