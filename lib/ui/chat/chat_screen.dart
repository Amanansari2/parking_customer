...
import 'package:parkinghawkernew/controller/chat_controller.dart';
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            chatModel.message.toString(),
                            style: TextStyle(color: themeChange.getThem() ? AppThemData.white : AppThemData.white, fontFamily: AppThemData.regular, fontSize: 14),
                          ),
                        ),
                      ),
                    ),
