...
class RoundedButtonFillGradientIcon extends StatelessWidget {
  final String title;
  final double? width;
  final double? height;
  ...
  const RoundedButtonFillGradientIcon({super.key, required this.title, this.height, required this.onPress, this.width, this.icon, this.fontSizes, this.textColor, this.isRight});
